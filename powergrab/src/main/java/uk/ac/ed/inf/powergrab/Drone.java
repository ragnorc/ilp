...
abstract class Drone {
	...
	protected final ArrayList<Feature> orginalFeatures;
	protected final String mapSource;
	 ...
	 * Description:	The method computes the best best path to a given goal position while avoiding negative stations. It iterates through the directions,
